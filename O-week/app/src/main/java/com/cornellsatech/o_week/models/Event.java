...
public class Event implements Comparable<Event>
{
	 ...
	 * @param placeID For example, ChIJDaE2e_OB0IkRKQUNUO8JluE
	 * @param pk Unique positive ID given to each event starting from 1.
	 */
	public Event(String title, String caption, @Nullable String description, int category, LocalDate date, LocalTime startTime, LocalTime endTime, boolean required, boolean categoryRequired, String additional, String placeID, int pk)
	{
		this.title = title;
	...
	public static Event fromString(String string)
	{
		...
		return new Event(title, caption, description, Integer.valueOf(category), LocalDate.parse(date, DATABASE_DATE_FORMATTER),
				...
				required.equals("1"), categoryRequired.equals("1"), additional, placeID, Integer.valueOf(pk));
	}
}
